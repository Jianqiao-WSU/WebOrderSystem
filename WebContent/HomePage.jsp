...
<body>
	...
	<div id="page-header">
		<h1>网上点餐系统</h1>
			...
			<div>
				<a href="Update_Customer.jsp" class="ui-btn ui-icon-search ui-btn-icon-left">查询并修改个人信息</a>	
			</div>
			<div>
				<a href="myorder.jsp" class="ui-btn ui-icon-search ui-btn-icon-left">查询个人订单</a>	
			</div>
			<div>
				<form name="formlogin" action="SearchServlet" method="POST">
							<div class="form-group">
								<input type="text" class="form-control" name="search">
								<input type="submit" value="搜索" data-icon="search">
							</div>  
				</form>
			</div>
